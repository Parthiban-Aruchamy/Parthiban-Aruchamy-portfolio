...
const projects: Project[] = [
  {
    ...
    bullets: [
      ...
      "Integrated an AI Builder (GPT-based) analysis layer generating a weekly industry synthesis — Auto trends, competitive moves, and upcoming developments — evaluated against licensing and capacity constraints for cost tradeoffs.",
    ],
    stack: [
      "Power Automate",
      "Excel Online",
